...
#define FIELD_IMM_S(instr)                                                     \
  ((((((signed int)instr) >> 25) << 5) | (((instr) >> 7) & 0x1F)))
...
extern int issue_fu_int(fu_int_t *, prop_t); // removed pc here
extern int issue_fu_fp(fu_fp_t *, prop_t);

extern void advance_fu_int(fu_int_t *, prop_t *);
extern void advance_fu_fp(fu_fp_t *, prop_t *);
